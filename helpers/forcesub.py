...
async def ForceSub(bot: Client, event: Message):
    """
    Custom Pyrogram Based Telegram Bot's Force Subscribe Function by @DeepakV111.
    ...
    try:
        ...
        print(f"Unable to do Force Subscribe to {Config.UPDATES_CHANNEL}\n\nError: {err}\n\nContact Support : https://t.me/DeepakV111")
        return 200
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/DeepakV111).",
                parse_mode="markdown",
